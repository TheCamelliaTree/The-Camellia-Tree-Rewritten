...
function standard(decimal, precision){
	...
	if (decimal.layer > 4 || (decimal.mag > Math.log10(3e132) && decimal.layer == 4)) {
		var slog = decimal.slog()
